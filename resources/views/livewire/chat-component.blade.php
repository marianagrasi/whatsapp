<div class="bg-gray-50 rounded-lg shadow border border-gray-200 overflow-hidden">
    <div class="grid grid-cols-3 divide-x divide-gray-200">
                    ...
                    <div class="px-4 py-3">
                        ...
                        <ul class="space-y-4">
                            @forelse ($this->contacts as $contact)
                                <li class="cursor-pointer" wire:click.live="open_chat_contact({{$contact}})">
                                    <div class="flex">
                                        <figure class="flex-shrink-0">
                                            <img class="h-12 w-12 rounded-full object-cover object-center" src="{{ $contact->user->profile_photo_url }}"
                                                alt="{{ $contact->name }}">
                ...
                @else
                    @foreach ($this->chats as $chatItem)
                        <div wire:key="chats--{{$chatItem->id}}"
                         ...
                         class="flex items-center justify-between {{$chat && $chat->id == $chatItem->id ? 'bg-gray-100 ' : 'bg-white'}} hover:bg-gray-100 cursor-pointer p-x3">
                            <figure>
        ...
        <div class="col-span-2">
            @if ($contactChat || $chat)
                <div class="bg-gray-100 h-10 flex items-center px-3">
                    <figure>
                        @if ($chat)
                ...
                <form class="bg-gray-100 h-16 flex items-center px-4" wire:submit.prevent="sendMessage()">
                    <x-input wire:model.live="bodyMessage" type="text" class="flex-1" placeholder="Esribe un mensaje acá">
                    </x-input>
                    <button class="flex-shrik-0 ml-4 text-2xl text-gray-600 ">
            ...
            @else
                <div class="w-full h-full flex justify-center items-center ">
                    <div class="">
                        <div class="_alyr"><svg width="360" height="189" viewBox="0 0 360 189" fill="none"
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    fill="#DAF7F3"></path>
                                <rect x="0.350314" y="0.491301" width="36.3309" height="71.7205" rx="6.39808"
                                    transform="matrix(0.986206 0.165525 -0.16491 0.986309 53.5541 83.2331)" fill="#42CBA5"
                                    stroke="#316474" stroke-width="0.853077"></rect>
                                <rect x="0.353963" y="0.496419" width="36.322" height="71.7116" rx="6.39363"
                                    transform="matrix(0.986206 0.165525 -0.16491 0.986309 53.9368 80.9482)" fill="white"
                                    stroke="#316474" stroke-width="0.861963"></rect>
                                <path
                                    ...
                                    fill="#EEFEFA" stroke="#316474" stroke-width="0.861963"></path>
                                <path
                                    ...
                                    fill="white" stroke="#316474" stroke-width="0.853077"></path>
                                <path
                                    ...
                                    fill="#42CBA5" stroke="#316474" stroke-width="1.72407"></path>
                                <path
                                ...
                                <path
                                    ...
                                    fill="#33AF8D"></path>
                                <path d="M125.463 42.5443L286.19 25.6512L297.132 129.758L136.405 146.652L125.463 42.5443Z"
                                    fill="#EEFEFA"></path>
                                <path
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    fill="#316474" fill-opacity="0.24"></path>
                                <path
